...
for j=1:m.nbQuads
    ...
    % Calcul de dx ou dy pour chaque point parcouru
    ...
    R=sqrt(m.POS(p1,1)^2+m.POS(p1,2)^2);
    rhs(p1)=20*(R-1.5).^2.*(R-2).^2.*(R>1.5).*(R<2)-0.5*R.^2.*(R-1).^2.*(R<1);
    R=sqrt(m.POS(p2,1)^2+m.POS(p2,2)^2);
    rhs(p2)=20*(R-1.5).^2.*(R-2).^2.*(R>1.5).*(R<2)-0.5*R.^2.*(R-1).^2.*(R<1);
    R=sqrt(m.POS(p3,1)^2+m.POS(p3,2)^2);
    rhs(p3)=20*(R-1.5).^2.*(R-2).^2.*(R>1.5).*(R<2)-0.5*R.^2.*(R-1).^2.*(R<1);
    R=sqrt(m.POS(p4,1)^2+m.POS(p4,2)^2);
    rhs(p4)=20*(R-1.5).^2.*(R-2).^2.*(R>1.5).*(R<2)-0.5*R.^2.*(R-1).^2.*(R<1);
