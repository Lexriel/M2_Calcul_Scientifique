	...
	plot  "dat/time_big.dat" using 2:3 with lines title 'GPU Divide and Conquer' ls 7, "dat/time_big.dat" using 2:4 with lines title 'CPU Horner' ls 6, "dat/time_big.dat" using 2:5 with lines title 'CPU Divide and Conquer' ls 5
