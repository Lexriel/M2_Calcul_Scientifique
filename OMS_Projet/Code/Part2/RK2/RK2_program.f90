...
! test for  A0 = (/0.1,-0.5, 0.3, 1./) at the beginning, now we use a vecotr A0 found running this program :
 A0 =(/ 2.102945603204218*10.**(-2.),  3.251445500445576*10.**(-3.),  2.102945603572754*10.**(-2.), -3.251446003032666*10.**(-3.) /)
