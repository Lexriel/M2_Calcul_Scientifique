...
// Allocations dynamiques
  ...
  voisin = (int*) malloc(m*sizeof(int));
...
// Recherche d'une meilleure solution tant qu'un voisin en propose une
      ...
      // initialisation de la meilleure solution et du meilleur score à l'étape k=0 et crée la meilleure solution et le meilleur score si il en a un après
      if ( (k == 0) || ( (k != 0) && (score < best_score) ) )
        {
          memcpy(meilleure_solution, solution, n*sizeof(int));
          best_score = score;
